            ...
            <div class="relative animate-slide-up">
                <div class="bg-white rounded-2xl p-8 shadow-2xl">
                    ...
                    <form action="{{ route('services.index') }}" method="GET" class="space-y-4">
                        <div>
                            <input type="text" name="search" placeholder="What service do you need?" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent text-gray-900">
                        </div>
                        <div>
                            <select name="category" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent text-gray-900">
                        ...
                        <div>
                            <input type="text" name="location" placeholder="Enter your location" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent text-gray-900">
                        </div>
                        <button type="submit" class="w-full bg-black text-white py-3 rounded-lg font-semibold hover:bg-gray-800 transition-colors duration-200">
                            Search Services
                        </button>
                    </form>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="text-center">
                <div class="text-3xl md:text-4xl font-bold text-gray-900 mb-2">{{ number_format($stats['total_services']) }}+</div>
                <div class="text-gray-600">Active Services</div>
            </div>
            <div class="text-center">
                <div class="text-3xl md:text-4xl font-bold text-gray-900 mb-2">{{ number_format($stats['total_providers']) }}+</div>
                <div class="text-gray-600">Verified Providers</div>
            </div>
            <div class="text-center">
                <div class="text-3xl md:text-4xl font-bold text-gray-900 mb-2">{{ number_format($stats['total_bookings']) }}+</div>
                <div class="text-gray-600">Completed Bookings</div>
            </div>
            <div class="text-center">
                <div class="text-3xl md:text-4xl font-bold text-gray-900 mb-2">{{ number_format($stats['average_rating'], 1) }}/5</div>
...
<section class="py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">Discover services across various categories tailored to your needs</p>
        </div>
        
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            @foreach($categories as $category)
                <a href="{{ route('categories.show', $category) }}" class="group bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-200 border border-gray-100 hover:border-gray-200">
                    <div class="text-center">
                        @if($category->icon)
        ...
        <div class="text-center mt-8">
            <a href="{{ route('categories.index') }}" class="inline-flex items-center px-6 py-3 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors duration-200">
                View All Categories
...
<section class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="text-sm text-gray-600 ml-1">{{ number_format($service->average_rating, 1) }}</span>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('services.show', $service) }}" class="bg-black text-white px-4 py-2 rounded-lg text-sm hover:bg-gray-800 transition-colors duration-200">
                                Book Now
                            </a>
                        </div>
                    </div>
        ...
        <div class="text-center mt-8">
            <a href="{{ route('services.index') }}" class="inline-flex items-center px-6 py-3 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors duration-200">
                View All Services
                <i data-feather="arrow-right" class="w-4 h-4 ml-2"></i>
            </a>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center">
                ...
                <p class="text-gray-600">Browse through our verified service providers and choose the one that fits your needs and budget.</p>
            </div>
            <div class="text-center">
                <div class="w-16 h-16 bg-black rounded-full flex items-center justify-center mx-auto mb-6">
                ...
                <p class="text-gray-600">Select your preferred date and time, make secure payment through our integrated payment gateways.</p>
            </div>
            <div class="text-center">
                <div class="w-16 h-16 bg-black rounded-full flex items-center justify-center mx-auto mb-6">
                ...
                <p class="text-gray-600">Enjoy quality service from our professional providers and rate your experience.</p>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="flex items-center">
                        <div class="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center mr-3">
                            @if($review->customer->avatar)
                                <img src="{{ $review->customer->avatar }}" alt="Avatar" class="w-10 h-10 rounded-full object-cover">
                            @else
...
<section class="py-16 bg-black text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">Join thousands of satisfied customers who trust D'RANiK Techs for their service needs.</p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('register') }}" class="bg-white text-black px-8 py-4 rounded-lg font-semibold hover:bg-gray-200 transition-colors duration-200">
                Sign Up Now
            </a>
            <a href="{{ route('services.index') }}" class="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-black transition-colors duration-200">
                Browse Services
            </a>
        </div>
    </div>
